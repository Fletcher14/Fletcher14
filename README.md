...
**3 · The return path — [patient-lookup-portal](https://github.com/Fletcher14/patient-lookup-portal)**
...
the diagnosis and what was done, beside their own field impression, with protected diagnoses
never shown. Scoped before any code, with the rules proven by tests before any server existed:
a refused request never reaches the hospital, and nothing is shown unless the lookup can be audited.
